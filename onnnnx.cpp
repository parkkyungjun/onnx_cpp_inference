...
int main()
{
    ...
    const string imageFile = "D:\\dacon_suhwa\\test_299\\006.png";
    const string labelFile = "D:\\onnx\\suhwa.txt";
    auto modelPath = L"D:\\onnx\\suhwa.onnx";
